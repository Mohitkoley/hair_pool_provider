              ...
              itemBuilder: (context,index){
                return Container(width: Get.width,
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                    ...
                    border: Border.all(color: Theme.of(context).textTheme.bodySmall!.color!.withOpacity(0.1))
                  ),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      child: Row(children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: robotoRegular.copyWith(color:  Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.8)),
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
                      ],),
                    ...
                    Divider(color: Theme.of(context).textTheme.bodySmall!.color!.withOpacity(0.2),),
