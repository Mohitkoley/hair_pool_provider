    ...
    return GetBuilder<BookingDetailsController>(builder: (bookingDetailsController){
      ...
      return  Container(
        decoration: BoxDecoration(
          ...
          boxShadow: <BoxShadow>[
            BoxShadow(
              color: Get.isDarkMode?Theme.of(context).primaryColor.withOpacity(0.2):Theme.of(context).primaryColor.withOpacity(0.07), // Shadow color
              spreadRadius: 1,
              blurRadius: 3,
              ...
              child: PopupMenuButton<String>(
                ...
                child: Container(
                  ...
                  child: Row( mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text(bookingDetails.bookingStatus?.tr ?? "",style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withOpacity(0.7))
                    ),
