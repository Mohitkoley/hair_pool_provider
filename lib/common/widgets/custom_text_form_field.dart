...
class CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.8), fontSize: Dimensions.fontSizeDefault),
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(widget.borderRadius),
          borderSide:  BorderSide(color: Get.isDarkMode?Theme.of(context).disabledColor:Theme.of(context).hintColor.withOpacity(0.5)),
        ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color:  widget.fillColor !=null ? Colors.transparent : Theme.of(context).primaryColor.withOpacity(0.0),
            ),
