...
import 'package:demandium_provider/feature/booking_details/view/qr_code_scan_screen.dart';
...
class ChangeStatusDropdownButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BookingDetailsController>(
      ...
      if (isSubBooking &&
          bookingDetails.isPaid == 1 &&
          statusList.contains("canceled")) {
        statusList.remove("canceled");
      }

      String dropdownStatus = isSubBooking
        ...
        child: Padding(
          ...
          child: bookingDetails.bookingStatus == 'pending'
                      ...
                      onPressed: bookingDetailsController.isAcceptButtonLoading
                          ...
                          : () {
                              showCustomDialog(
                                ...
                                title:
                                    "are_you_sure_to_ignore_the_booking_request"
                                        .tr,
                                ...
                                onYesPressed: () {
                                  bookingDetailsController
                                      .ignoreBookingRequest(bookingId);
                                  Get.back();
                                  Get.back();
                                },
                              ));
              ...
              Row(children: [
                  ...
                  //       bookingDetailsController
                  //           .changeBookingStatusDropDownValue(
                  //               newValue, isSubBooking);
                  ...
                  //                 1 &&
                  //             bookingDetailsController
                  //                 .pickedPhotoEvidence.isNotEmpty) {
                  //           bookingDetailsController.changePhotoEvidenceStatus(
                  //               status: true);
                  ...
                  bookingDetailsController.isStatusUpdateLoading
                      ...
                      : CustomButton(
                          ...
                          btnTxt: bookingDetails.bookingStatus == "accepted"
                              ? "Scan to start"
                              : "Scan to finish",
                          onPressed:
                            ...
                            Get.to(
                              ...
                              if (value != null && value == bookingDetails.id) {
                                log("value: $value , status ${bookingDetails.bookingStatus}");
                                  ...
                                  showDialog(
                                      ...
                                      builder: (context) {
                                        return AlertDialog.adaptive(
                                          title: Text("Booking Status"),
                                          content: Text(
                                              "Do you want to Finish the Service ?"),
                                          actions: [
                                            TextButton(
                                                onPressed: () {
                                                  Navigator.pop(context);
