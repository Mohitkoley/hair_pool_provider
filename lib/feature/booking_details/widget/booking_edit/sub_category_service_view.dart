...
class _SubcategoryServiceViewState extends State<SubcategoryServiceView>  with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ServiceCategoryController>(builder: (categoryController){
      return Container(
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min,crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            GetBuilder<ServiceCategoryController>(builder: (serviceController){

              if(widget.serviceList.isEmpty){
                return SizedBox( height: Get.height/2, child: NoDataScreen(text: 'no_services_found'.tr,type: NoDataType.service,));
                              ...
                              child: Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                                ...
                                Expanded(
                                  child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,children: [
                                    ...
                                    Text( widget.serviceList[index].name??"", style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
