                  ...
                  Stack(
                    children: [
                      Center(child: Column(children: [
                        ...
                        Text("${widget.postData.distance??"0 km"} ${'away_from_you'.tr}", style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8))
                        ),
                      ])),
                      if(postController.showInfoWidget)
                      Positioned(top: 30, left: 20, right: 20,
                        child: Container(
                          ...
                          child: Text("accept_service_request_instruction".tr,
                            style: robotoRegular.copyWith(color: Colors.white.withOpacity(0.8),fontSize: Dimensions.fontSizeSmall),textAlign: TextAlign.center,
                          ),
                        ),
                      )
                    ],
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(widget.postData.subCategory?.name??"",  style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8)),maxLines: 1, overflow: TextOverflow.ellipsis,),
                        ],),
                    )
                  ],
                  ),
