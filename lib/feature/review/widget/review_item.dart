  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: review.isActive == 0 ? Theme.of(context).disabledColor.withOpacity(
          Get.isDarkMode ? 0.3 : 0.1) : backgroundColor ?? Theme.of(context).primaryColor.withOpacity(0.05),
              ...
              Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                child: Row( children: [
                  ...
                  review.isActive == 0 ? CustomToolTip( message: "admin_turn_off_this_review".tr,
                    iconColor: Theme.of(context).primaryColor.withOpacity(0.7), size: 18,
                  ) : const SizedBox(),
                ]),
              ),

              Divider(height: 0.4, color: Theme.of(context).hintColor.withOpacity(0.5),),
                          ...
                          children: [
                            Flexible(
                              child: Text("${review.customer?.firstName ?? ""} ${review.customer?.lastName ?? ""}",
                                style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(1)),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: review.isActive == 0 ? Theme.of(context).disabledColor.withOpacity(0.01) : Theme.of(context).cardColor
                      ),
