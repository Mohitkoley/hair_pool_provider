                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: ColorResources.buttonTextColorMap[transactionsList[index].requestStatus]?.withOpacity(0.2)
                                    ),
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Padding(
                                      ...
                                      child: CustomBookingDetailsExpansionTile(
                                        ...
                                        bookingTitleColor: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.8),
                                        children: [
