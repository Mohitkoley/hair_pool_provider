...
class PickMapScreen extends StatefulWidget {
  ...
  const PickMapScreen({super.key,  this.initialPosition, this.initialAddress});
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                      child: Text(
                        locationController.pickAddress != "" ? locationController.pickAddress : widget.initialAddress ?? "",
