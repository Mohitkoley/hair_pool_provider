...
class BookingDetailsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BookingDetailsController>(
      initState: (_) => Get.find<BookingDetailsController>()
          .showHideExpandView(0, shouldUpdate: false),
      builder: (bookingDetailsController) {
        ...
        if (bookingDetailsContent == null &&
        ...
        } else if (bookingDetailsContent != null &&
            bookingDetailsContent.content == null) {
          return SizedBox(
          ...
          bool isPartial = (bookingDetails!.partialPayments != null &&
          ...
          return Scaffold(
                  ...
                  onRefresh: () async {
                    if (isSubBooking) {
                      await Get.find<BookingDetailsController>()
                          .getBookingSubDetails(subBookingId ?? "",
                              reload: false);
                    } else {
                      await Get.find<BookingDetailsController>()
                        ...
                        bookingDetails.bookingStatus != 'pending'
                            ? Row(
                                ...
                                children: [
                                    ...
                                    Expanded(
                                      child: CustomButton(
                                        btnTxt: "edit_booking".tr,
                                        icon: Icons.edit,
                                        onPressed: (!subBookingPaid &&
                                                configModel.content
                                                        ?.providerCanEditBooking ==
                                                    1 &&
                                                !isPartial &&
            ...
            floatingActionButton: bookingDetailsController.isShowChattingButton(
                    bookingDetails, tabController)
                ? Padding(
                    padding: EdgeInsets.only(
                        bottom: GetPlatform.isAndroid ? 70 : 35),
                    child: Column(
                          ...
                          child: FloatingActionButton(
                            ...
                            onPressed: () async => await launchUrl(
                              Uri(
                                scheme: 'tel',
                                path: bookingDetails
                                        .serviceAddress?.contactPersonNumber ??
