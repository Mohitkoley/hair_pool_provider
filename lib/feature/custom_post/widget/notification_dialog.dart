                        ...
                        Stack(
                          children: [
                            Center(child: Column(children: [
                              ...
                              Text("${postData?.distance??"0 km"} ${'away_from_you'.tr}", style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8))
                              ),
                            ])),
                          ],
                        ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(postData?.subCategory?.name??"",
                                  style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).secondaryHeaderColor.withOpacity(0.8)), maxLines: 1, overflow: TextOverflow.ellipsis,
                                ),
                              ],
                            ),
                          )
