...
class PdfInvoiceApi {
  static Future<File> generate(BookingDetailsContent bookingDetailsContent,
      List<InvoiceItem> items, BookingDetailsController controller) async {
    final pdf = Document();

    ImageProvider? imageProvider;

    try {
      imageProvider = await downloadImage(
    ...
    return PdfApi.saveDocument(
        name: 'invoice_${bookingDetailsContent.readableId}.pdf', pdf: pdf);
  }

  static Widget buildHeader(
          Invoice invoice, BookingDetailsContent bookingDetailsContent) =>
      Column(
  ...
  static Widget companyImage(var netImage,
  ...
  static Widget buildCustomerAddress(
      ...
      Column(
        ...
        children: [
          ...
          if (bookingDetailsContent.customer != null)
            Text(
              'Customer Name: ${bookingDetailsContent.customer!.firstName} ${bookingDetailsContent.customer!.lastName!}',
            ),
          SizedBox(height: 1 * PdfPageFormat.mm),
          if (bookingDetailsContent.customer != null &&
              bookingDetailsContent.customer!.email != null)
            Text('Email: ${bookingDetailsContent.customer!.email}'),
          SizedBox(height: 1 * PdfPageFormat.mm),
          if (bookingDetailsContent.customer != null &&
              bookingDetailsContent.customer!.phone != null)
          ...
          if (bookingDetailsContent.serviceAddress != null)
            Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
              SizedBox(
                width: Get.width * .4,
                child: Text(
                  'Address: ${bookingDetailsContent.serviceAddress != null ? bookingDetailsContent.serviceAddress!.address : ""}',
                ),
              ),
            ]),
          SizedBox(height: 4 * PdfPageFormat.mm),
          Text(
              "Payment Status: ${bookingDetailsContent.partialPayments != null && bookingDetailsContent.partialPayments!.isNotEmpty && bookingDetailsContent.isPaid == 0 ? "Partially paid" : bookingDetailsContent.isPaid.toString() == '0' ? 'Unpaid' : 'Paid'}",
              style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold))
        ],
      );

  static Widget buildInvoiceInfo(
      InvoiceInfo? info, BookingDetailsContent bookingDetailsContent) {
    final data = <String>[
    ...
    return Column(
        ...
        children: [
          ...
          if (bookingDetailsContent.provider != null &&
              bookingDetailsContent.provider!.companyName != null)
            Text(
              '${bookingDetailsContent.provider!.companyName}',
            ),
          SizedBox(height: 1 * PdfPageFormat.mm),
          if (bookingDetailsContent.provider != null &&
              bookingDetailsContent.provider!.companyPhone != null)
            Text(
              '${bookingDetailsContent.provider!.companyPhone}',
            ),
          SizedBox(height: 1 * PdfPageFormat.mm),
          if (bookingDetailsContent.provider != null &&
              bookingDetailsContent.provider!.companyAddress != null)
            Text(
  ...
  static Widget buildInvoice(Invoice invoice) {
    ...
    return TableHelper.fromTextArray(
      ...
      headerStyle: TextStyle(
          fontWeight: FontWeight.bold, color: PdfColor.fromHex("f2f2f2")),
  ...
  static Widget buildTotal(BookingDetailsContent bookingDetailsContent,
    ...
    bool isPartialPayment = bookingDetailsContent.partialPayments != null &&
        bookingDetailsContent.partialPayments!.isNotEmpty;
    ...
    if (isPartialPayment) {
      ...
      paidAmount =
          totalBookingAmount - (bookingDetailsContent.additionalCharge ?? 0);
    }
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                if (bookingDetailsContent.totalReferralDiscountAmount != null &&
                    bookingDetailsContent.totalReferralDiscountAmount! > 0)
                  buildText(
                    title: 'Referral discount',
                    value:
                        '(-) ${bookingDetailsContent.totalReferralDiscountAmount.toString()}',
                    unite: true,
                  ),

                if (bookingDetailsContent.extraFee != null &&
                    bookingDetailsContent.extraFee! > 0)
                  buildText(
                    title: Get.find<SplashController>()
                        ...
                        "",
                    value:
                        "(+) ${bookingDetailsContent.extraFee?.toStringAsFixed(2)}",
                    unite: true,
                  ),
                ...
                Divider(),
                bookingDetailsContent.partialPayments != null &&
                        bookingDetailsContent.partialPayments!.isNotEmpty
                    ? Column(children: [
                        buildText(
                          title: 'Grand Total',
                          ...
                          value: double.tryParse(controller
                                  .bookingDetails!.content!.totalBookingAmount
                                  .toString())!
                              .toStringAsFixed(2),
                          unite: true,
                        ),
                        ListView.builder(
                          itemBuilder: (context, index) {
                            String paidWith = bookingDetailsContent
                                    .partialPayments?[index].paidWith ??
                                "";

                            return buildText(
                                title:
                                    '${paidWith == "digital" && bookingDetailsContent.paymentMethod == "offline_payment" ? "" : (paidWith == "wallet" || paidWith == "digital") ? "Paid by '" : ""}'
                                ...
                                value: bookingDetailsContent
                                        .partialPayments?[index].paidAmount
                                        .toString() ??
                                    "0");
                          },
                          itemCount:
                              bookingDetailsContent.partialPayments!.length,
                        ),
                        bookingDetailsContent.partialPayments?.length == 1 &&
                                dueAmount > 0
                            ? buildText(
                                title: "Due amount (Cash after service)",
                                value: "$dueAmount")
                            : SizedBox(),
                        if (bookingDetailsContent.additionalCharge != 0 &&
                            bookingDetailsContent.paymentMethod !=
                                "cash_after_service")
                          buildText(
                            title: bookingDetailsContent.additionalCharge !=
                                        null &&
                                ...
                                ? (bookingDetailsContent.bookingStatus ==
                                        ...
                                        bookingDetailsContent.bookingStatus ==
                                            "ongoing")
                                    ? 'Due Amount (Cash after service)'
                                    : "Paid Amount (Cash after service)"
                                : "Refund amount",
                            titleStyle: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.normal,
                            ),
                            value: (bookingDetailsContent.additionalCharge ?? 0)
                                .toStringAsFixed(2),
                            unite: true,
                          ),
                      ])
                    : Column(children: [
                        ...
                        if (bookingDetailsContent.additionalCharge != null &&
                            bookingDetailsContent.additionalCharge! > 0 &&
                            bookingDetailsContent.paymentMethod !=
                                "cash_after_service")
                          Column(children: [
                            buildText(
                              title:
                                  'Paid Amount (${bookingDetailsContent.paymentMethod == "offline_payment" ? "Offline" : bookingDetailsContent.paymentMethod == "wallet_payment" ? "Wallet" : bookingDetailsContent.paymentMethod == "cash_after_service" ? "Cash After Service" : bookingDetailsContent.paymentMethod})',
                              titleStyle: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.normal,
                              ),
                              value: ((bookingDetailsContent
                                              .totalBookingAmount ??
                                          0) -
                                      (bookingDetailsContent.additionalCharge ??
                                          0))
                                  .toStringAsFixed(2),
                              unite: true,
                            ),
  ...
  static Widget buildInvoiceImage(ImageProvider? netImage,
      BookingDetailsContent bookingDetailsContent, Invoice invoice) {
    return Container(
