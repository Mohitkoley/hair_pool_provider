          ...
          child: Container(decoration: BoxDecoration(color: Theme.of(context).cardColor,
            ...
            child: Column(
              children: [
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                      Text("${postData.customer?.firstName??""} ${postData.customer?.lastName??""}",
                          style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge,color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.7)),
                ...
                Divider(color: Theme.of(context).primaryColor.withOpacity(0.2),height: 1,),
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.start,children: [
                        Text(postData.service?.name??"", style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.7)),
                            maxLines: 1, overflow: TextOverflow.ellipsis),
