  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        Stack( clipBehavior: Clip.none,children: [
          ClipPath(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isSelected ? Colors.white.withOpacity(0.05) : Theme.of(context).primaryColor.withOpacity(0.07),
                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              ),
            ),
          ),
          ...
          Column(children: [
            ...
            Text(selectedPackage.duration !=null ? "${selectedPackage.duration ?? ""} ${"days".tr}" : "", style: robotoRegular.copyWith(
              color: isSelected ? Colors.white.withOpacity(0.8) : Theme.of(context).primaryColor.withOpacity(0.8),
            )),
          ],),
        ...
        Container(
          height: 0.5 ,
          color: isSelected ? Colors.white.withOpacity(0.5) : Theme.of(context).primaryColor.withOpacity(0.5),
