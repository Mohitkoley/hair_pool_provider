    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text("submit_service_proof".tr , style: robotoBold.copyWith(
            fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.8)
        ),),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ...
          InkWell(
            ...
            child: Column(children: [
              ...
              Text('upload_image'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(0.7))),
            ]),
          ),
          ...
          InkWell(
            ...
            child: Column(children: [
              ...
              Text('take_photo'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodySmall?.color?.withOpacity(0.7)))
            ]),
          ),
          const SizedBox(),
        ]),
