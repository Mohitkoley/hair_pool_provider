        ...
        if(userProfileController.providerModel !=null){
          ...
          return Container(
            decoration: BoxDecoration(
                ...
                border: Border.all(color: payablePercent >= 80 ? Theme.of(context).colorScheme.error.withOpacity(0.20) : Theme.of(context).primaryColor.withOpacity(0.15)),
                color: Get.isDarkMode? Colors.grey.withOpacity(0.2) :  payablePercent >= 80 ? Theme.of(context).colorScheme.error.withOpacity(0.05) : Theme.of(context).primaryColor.withOpacity(0.03)
            ),
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault -1, color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.8)),
