                ...
                Column(
                  children: [
                    ...
                    subscribedPackageDetails?.isCanceled == 0 && remainingDays > 0 ? CustomButton(
                      color: Theme.of(context).primaryColorLight.withOpacity(0.07),
...
class BillingDetailsItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(title?.tr ?? "", style: robotoMedium.copyWith(color: Theme.of(context).hintColor.withOpacity(0.7), fontSize: Dimensions.fontSizeDefault),),
