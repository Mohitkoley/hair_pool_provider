  ...
  Widget build(BuildContext context) {
    return GetBuilder<ServiceCategoryController>(builder: (serviceCategoryController){
      return Container(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: selectedCategory == title ? Get.isDarkMode? Theme.of(context).colorScheme.surface : Theme.of(context).primaryColor.withOpacity(.05) : Theme.of(context).cardColor,
            borderRadius: BorderRadius.only(
