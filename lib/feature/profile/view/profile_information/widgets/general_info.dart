                  ...
                  child: SingleChildScrollView(
                    child: Column(children: [
                      ...
                      Container(
                        ...
                        child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Text("basic_information".tr, style: robotoBold.copyWith(
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                        ...
                        Text("same_as_general_info".tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                      ...
                      Container(
                        ...
                        child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Text("contact_person_info_title".tr, style: robotoBold.copyWith(
                                fontSize: Dimensions.fontSizeLarge
                            )),
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.start,
              children: [
                ...
                Text("same_as_general_info".tr, style: robotoMedium.copyWith(color: Theme.of(context).primaryColor),),
              ],
            ),
          ],
        );
