...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String privacyPolicy =
        Get.find<SplashController>().configModel.content!.privacyPolicy!;
    String termsAndCondition =
        Get.find<SplashController>().configModel.content!.termsAndConditions!;
    String refundPolicy =
        Get.find<SplashController>().configModel.content!.refundPolicy!;
    String cancellationPolicy =
        Get.find<SplashController>().configModel.content!.cancellationPolicy!;
      ...
      if (aboutUs != '')
        MenuModel(
            ...
            route: RouteHelper.getHtmlRoute(
                page: 'about_us', fromPage: "about_us")),
      if (privacyPolicy != '')
        MenuModel(
            icon: Images.privacyPolicyIcon,
            title: 'privacy_policy'.tr,
            route: RouteHelper.getHtmlRoute(page: 'privacy-policy')),
      if (termsAndCondition != '')
        MenuModel(
            icon: Images.termsConditionIcon,
            title: 'terms_and_condition'.tr,
            route: RouteHelper.getHtmlRoute(page: 'terms-and-condition')),
      if (refundPolicy != '')
        MenuModel(
            icon: Images.refund,
            title: 'refund_policy'.tr,
            route: RouteHelper.getHtmlRoute(page: 'refund-policy')),
      if (cancellationPolicy != '')
        MenuModel(
            icon: Images.cancellation,
            title: 'cancellation_policy'.tr,
            route: RouteHelper.getHtmlRoute(page: 'cancellation-policy')),
      MenuModel(
          icon: Images.logout,
