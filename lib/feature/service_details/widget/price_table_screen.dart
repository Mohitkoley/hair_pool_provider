                      ...
                      ListView.separated(
                        ...
                        separatorBuilder: (context, index){
                          return Padding(
                            ...
                            child: Divider(thickness: 1, color: Theme.of(context).hintColor.withOpacity(0.2)),
                          );
                        },
                            ...
                            Flexible(
                              child: Text(serviceDetailsController.variantList[index].variantName.replaceAll('-', ' ').capitalizeFirst!,
                                style: robotoRegular.copyWith(
                                  fontSize: Dimensions.fontSizeLarge,
                                  color:  Get.isDarkMode ? Theme.of(context).primaryColorLight : Colors.black.withOpacity(0.8),
                                ),
                              ),
                            ),
