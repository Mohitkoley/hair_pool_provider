                ...
                builder: (controller) => Column(children: [
                  Stack(children: [
                    Column(
                          ...
                          Padding(
                            ...
                            child: IntrinsicWidth(
                              ...
                              textAlign: TextAlign.center,
                                ...
                                style: robotoBold.copyWith(fontSize: 20,color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.8)),
                      ...
                      Row(
                        children: [
                          Text("available_balance".tr,style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5)),),
                        ...
                        Row(
                          children: [
                            Text("minimum_withdraw_amount".tr,style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5)),),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
                        ...
                        Row(
                          children: [
                            Text("maximum_withdraw_amount".tr,style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5)),),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
